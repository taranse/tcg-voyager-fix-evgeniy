                            ...
                            <div class="col-md-10 no-padding-left-right">
                                ...
                                <select class="form-control" name="{{ $setting->key }}">
                                    ...
                                    <option value="{{ $index }}" @if($default==$index &&
                                        ...
                                        @if($selected_value==$index){{ 'selected="selected"' }}@endif>{{ $option }}
                                    </option>
                                    @endforeach
                                    @endif
                                </select>
                                ...
                                @elseif($setting->type == 'todo_list')
                                <div class="wrapper todo_list_container">
                                    <div class="header form-group form-inline">
                                        <input type="text" placeholder="Введите" class="todo_input form-control">
                                        <button type="button" class="addBtn btn btn-primary">Добавить</button>
                                    </div>
                                ...
                                <input type="checkbox" name="{{ $setting->key }}" class="toggleswitch" @if($checked)
                                    checked @endif data-on="{{ $options->on }}" data-off="{{ $options->off }}">
                                @else
