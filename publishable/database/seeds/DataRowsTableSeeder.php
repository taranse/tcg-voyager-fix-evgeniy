...
class DataRowsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $settingGroupDataType = DataType::where('slug', 'settings-group')->firstOrFail();

        $dataRow = $this->dataRow($settingGroupDataType, 'id');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'number',
        ...
        $dataRow = $this->dataRow($settingGroupDataType, 'name');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
